...
%\includepdf[pages={1}]{coversheets/first-draft-coversheet.pdf}
%\input{../../outline.tex}
\doublespacing
\newpage
%\thispagestyle{empty}
...
%\input{Tensors/tensors.tex}
\input{Yamaguchi.tex}
\newpage
\singlespacing
%\bibliographystyle{rsc}
%\bibliography{/Users/karlpierce/Notes/Lit_Review/maketex_example-master/tex/references}
\end{document}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
